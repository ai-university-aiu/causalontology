...
- **The phased build.** (1) a persistent content-addressed node; (2) a genesis full node plus signed snapshot dumps; (3) Tier B federation with gossip and anti-entropy; (4) light clients, CDN caching, and hash-prefix sharding.

Full design: Part 21, "Commons Storage and Federation Design," in the canon ([`Causalontology_Standalone_Design_v17.txt`](Causalontology_Standalone_Design_v17.txt)).
...
- [ ] **Next — the commons as a living network:** the phased storage-and-federation build of Part 21 (a persistent content-addressed node, then signed snapshot dumps, then Tier B federation, then light clients and CDN caching and hash-prefix sharding)
...
> D. R. Dison. *Causalontology: AGI's Missing Link* — the Standalone Standard and the Shared Commons, Version 17 (Release Edition), specification 2.0.0. AI University (AIU), 2026. github.com/ai-university-aiu/causalontology
