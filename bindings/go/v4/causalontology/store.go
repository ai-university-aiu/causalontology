...
// ContentKinds names the immutable content object kinds. 2.0.0 had the
// type-tier and token-tier kinds; 3.0.0 adds the cross_stratal_seam; 4.0.0
// adds the attitude, the predicted_occurrence, and the prediction_error.
var ContentKinds = map[string]bool{
	...
	"stratum":                true,
	"bridge":                 true,
	"cross_stratal_seam":     true,
	"port":                   true,
	"conduit":                true,
	"quality":                true,
	"token_individual":       true,
	"token_occurrence":       true,
	"state_assertion":        true,
	"token_causal_claim":     true,
	"attitude":               true,
