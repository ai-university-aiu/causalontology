...
// excluded by construction. 2.0.0 had seventeen whole-word kinds; 3.0.0 adds
// the cross_stratal_seam and the conduit's realized_by; 4.0.0 adds the
// attitude, the predicted_occurrence, and the prediction_error - all additive
// and identity-preserving: a record that omits a new field keeps its earlier
