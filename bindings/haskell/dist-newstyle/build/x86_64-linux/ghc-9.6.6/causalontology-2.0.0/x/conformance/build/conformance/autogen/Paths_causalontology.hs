...
-- at runtime using the environment variable causalontology_bindir.
...
-- environment variable causalontology_libdir.
...
-- using the environment variable causalontology_dynlibdir.
...
-- runtime using the environment variable causalontology_datadir.
...
-- variable causalontology_libexedir.
...
-- using the environment variable causalontology_sysconfdir.
...
bindir     = "/home/ccaitwo/.cabal/bin"
libdir     = "/home/ccaitwo/.cabal/lib/x86_64-linux-ghc-9.6.6/causalontology-2.0.0-inplace-conformance"
dynlibdir  = "/home/ccaitwo/.cabal/lib/x86_64-linux-ghc-9.6.6"
datadir    = "/home/ccaitwo/.cabal/share/x86_64-linux-ghc-9.6.6/causalontology-2.0.0"
libexecdir = "/home/ccaitwo/.cabal/libexec/x86_64-linux-ghc-9.6.6/causalontology-2.0.0"
sysconfdir = "/home/ccaitwo/.cabal/etc"

getBinDir     = catchIO (getEnv "causalontology_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "causalontology_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "causalontology_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "causalontology_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "causalontology_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "causalontology_sysconfdir") (\_ -> return sysconfdir)
