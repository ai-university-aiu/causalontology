...
| Zig | pin the `v2.0.0` tag tarball by url + hash in `build.zig.zon` (`zig fetch` prints the hash); subdirectory package — set the module's `root_source_file` to `dep.path("bindings/zig/src/causalontology.zig")` |
