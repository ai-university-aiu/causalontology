...
| PHP | `composer require causalontology/causalontology:^4.0` (**v4.0.1 live on Packagist**, mirrored automatically from the tag; earlier tags remain) |
...
| Swift | `.package(url: "https://github.com/ai-university-aiu/causalontology", from: "4.0.1")` (**4.0.x via the fresh `v4.0.1` tag**, verified 137/137 at the tag; Swift Package Index listing submitted — [PackageList PR #14440](https://github.com/SwiftPackageIndex/PackageList/pull/14440)) |
