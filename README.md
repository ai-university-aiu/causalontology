...
- **`BOOK | AGI'S MISSING LINK`** — this repository is the data-structure layer of the book *Causalontology: AGI's Missing Link*, whose thesis is that the component most conspicuously missing from today's AI is an explicit, learnable, inspectable model of cause and effect, acquired by acting on the world. The complete, lay-readable canon is right here: [`Causalontology_Standalone_Design_v17.txt`](Causalontology_Standalone_Design_v17.txt).
...
Every term above is explained for a newcomer in the master document: [`Causalontology_Standalone_Design_v17.txt`](Causalontology_Standalone_Design_v17.txt) — the complete, self-contained canon of this repository.
...
| Dart | `dart pub add causalontology` (2.0.0 live on pub.dev; 1.0.0 retraction via admin UI) |
...
> D. R. Dison. *Causalontology: AGI's Missing Link* — the Standalone Standard and the Shared Commons, Version 15 (Release Edition), specification 2.0.0. AI University (AIU), 2026. github.com/ai-university-aiu/causalontology
